 ...
 * @returns {ErrorResponse} 500 - Server error
 */
router.get('/:userId', asyncHandler(profileController.getProfileById));
 ...
 * @returns {ErrorResponse} 500 - Server error
 */
router.patch('/update', asyncHandler(profileController.updateProfile));
...
router.patch(
  ...
  profileController.resizeUserAvatar,
  asyncHandler(profileController.updateAvatar)
);

/**
 * Update user interests
 * @route PATCH /api/profile/interests
 * @group Profile - User profile operations
 ...
 * @returns {ErrorResponse} 500 - Server error
 */
router.patch('/interests', asyncHandler(profileController.updateInterests));
 ...
 * @returns {ErrorResponse} 500 - Server error
 */
router.patch('/notifications', asyncHandler(profileController.updateNotificationSettings));
